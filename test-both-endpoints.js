  ...
  try {
    ...
    if (response.ok) {
      ...
      if (data.error === 'Authorization header required') {
        console.log(`❌ JWT_SECRET is NOT set in ${name}`);
...
async function testBothEndpoints() {
  ...
  if (JWT_TOKEN === 'YOUR_JWT_TOKEN_HERE') {
    ...
    console.log('');
    console.log('🔑 Your JWT_SECRET is: 4a26e4917d443a410275a40b5d007aec582a8ddbdf3d1b265f21d688fbd83c45');
    console.log('📝 DevOps needs to set this as JWT_SECRET environment variable in backend');
    return;
  }
  
  console.log('🔑 JWT_SECRET for DevOps: 4a26e4917d443a410275a40b5d007aec582a8ddbdf3d1b265f21d688fbd83c45');
  console.log('');
  ...
  if (!productionSuccess) {
    ...
    console.log('1. Contact DevOps to set JWT_SECRET environment variable');
    console.log('2. JWT_SECRET value: 4a26e4917d443a410275a40b5d007aec582a8ddbdf3d1b265f21d688fbd83c45');
