...
export const SIMPLE_SIGNER_URL = 'https://sign.stellar.expert'
...
export const generateChallengeXDR = (challenge: string, publicKey: string) => {
  try {
    ...
    const account = new Account(publicKey || 'GAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAWHF', '0')
